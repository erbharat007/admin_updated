...
<div class="bs-example">
	<!--<div class="row">
		<div class="col-sm-3">
			<div class="leftmenu tabsmenu">
				<ul>
					<li class="active" data-id="form-tab-1"><span class="glyphicon glyphicon-plus"></span> Employee Data</li>
					<li data-id="form-tab-2"><span class="glyphicon glyphicon-plus"></span> Personal Data</li>
					<li data-id="form-tab-3"><span class="glyphicon glyphicon-plus"></span> Salary Data</li>
					<li data-id="form-tab-4"><span class="glyphicon glyphicon-plus"></span> Set Up Authorizations</li>
					<li data-id="form-tab-5"><span class="glyphicon glyphicon-plus"></span> Attach Employee File</li>
				</ul>
			</div>
		</div>
		<div class="col-sm-9">
		 <div class="tab-section active" id="form-tab-1">
			<div class="formheader"><h4>Employee Data</h4></div>
			<div class="formsection">
				<div class="box">
					...
					<div class="col-sm-6">
						<div class="form-group">
							 <h5>Name</h5>
							 <select name="" class="form-control" data-bv-message="Please select City" required>
					...
					<div class="col-sm-6">
						<div class="form-group">
							 <div class="row">
							 	<div class="col-xs-3"><input type="checkbox" name=""> &nbsp;<span>Yas</span></div>
							 	<div class="col-xs-3"><input type="checkbox" name=""> &nbsp;<span>No</span></div>
							 </div>
						</div>
					</div>
					<div class="col-sm-6">
					...
					<div class="col-sm-6">
						<div class="form-group">
							 ...
							 <input type="button" name="" class="btn btn-warning" value="Reset">
						</div>
					</div>
				</div>
			</div>
		...
		<div class="tab-section" id="form-tab-2">
			<div class="formheader"><h4>Personal Data</h4></div>
			<div class="formsection">
				<div class="box">
					<div class="col-sm-12">
		...
		<div class="tab-section" id="form-tab-3">
			<div class="formheader"><h4>Salary Data</h4></div>
			<div class="formsection">
				<div class="box">
					<div class="col-sm-12">
		...
		<div class="tab-section" id="form-tab-4">
			<div class="formheader"><h4>Set Up Authorizations </h4></div>
			<div class="formsection">
				<div class="box">
					<div class="col-sm-12">
		...
		<div class="tab-section" id="form-tab-5">
			<div class="formheader"><h4>Attach Employee File</h4></div>
			<div class="formsection">
				<div class="box">
					<div class="col-sm-12">
			...
			<div class="formsection">
				...
				<div class="row">
					<div class="col-sm-5">
						<div class="form-group">
							<div class="row">
								<div class="col-sm-4"><h5>E-mail ID <span>*</span></h5></div>
						        <div class="col-sm-8"><input type="text"  name="name" placeholder="Your Name*" class="form-control" /></div>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-sm-5">
						<div class="form-group">
							<div class="row">
								<div class="col-sm-4"><h5>Home Address <span>*</span></h5></div>
						        <div class="col-sm-8"><input type="text"  name="name" placeholder="Your Name*" class="form-control" /></div>
							</div>
						</div>
					</div>
					<div class="col-sm-5 col-sm-offset-1">
						<div class="form-group">
							<div class="row">
								<div class="col-sm-4"><h5>Mobile Phone <span>*</span></h5></div>
						        <div class="col-sm-8"><input type="text"  name="name" placeholder="Your Name*" class="form-control" /></div>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-sm-5">
						<div class="form-group">
							<div class="row">
								<div class="col-sm-4"><h5>Employee Code <span>*</span></h5></div>
						        <div class="col-sm-8"><input type="text"  name="name" placeholder="Your Name*" class="form-control" /></div>
							</div>
						</div>
					</div>
					<div class="col-sm-5 col-sm-offset-1">
						<div class="form-group">
							<div class="row">
								<div class="col-sm-4"><h5>Employee Located <span>*</span></h5></div>
						        <div class="col-sm-8">
                                      <select name="" class="form-control" data-bv-message="Please select City" required class="form-control">
							  	           <option>Select</option>
							          </select>
