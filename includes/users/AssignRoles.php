<?php
require_once(CLASS_PATH."/class.AssignRole.inc.php");
$obj_assignroles=new AssignRoles;
...
{
	case "Add":
		$_SESSION['msg']=$obj_assignroles->add();
		break;

	case "Update":
		$_SESSION['msg']=$obj_assignroles->edit();		
		break;

	case "Edit":
		$rs_assignroles=$obj_assignroles->getrowbyid($_REQUEST['chkSelect']);
		$row_assignroles=$GLOBALS['obj_db']->fetch_array($rs_assignroles);
		break;

	case "Delete":
		$_SESSION['msg']=$obj_assignroles->delete();
		break;
}
?>
...
<div class="page-header">
	<h3>Assign Roles to Employees</h3>
</div>
<?php 
...
<div class="widget-content">
	<form action="index.php?Option=Users&SubOption=AssignRole" method="post" name="frmEdit" id="frmUpdate" class="form-horizontal col-md-6" role="form">
        <div class="form-group">
            <label class="col-md-3">User Name : </label>
            <label class="col-md-9"><input name="hdnUserID" type="hidden" id="hdnUserID"  value="<?php echo $row_assignroles['emp_id']?>"><?php echo $row_assignroles['first_name']." ".$row_assignroles['last_name'] ?> </label>
    	</div> <!-- /.form-group -->
        <div class="form-group">
...
?>
<div class="widget-content">
	<form action="index.php?Option=Users&SubOption=AssignRole" method="post" name="frmSearch" id="frmSearch" class="form-horizontal col-md-6" role="form">
        <div class="form-group">
...
if($action=="Search")
{
	$rs_assignroles=$obj_assignroles->search();	
}
else
{
	$rs_assignroles=$obj_assignroles->getall();
}
...
{
?>
<form action="index.php?Option=Users&SubOption=AssignRole" method="post" name="frmUpdate" id="frmUpdate">
    <div class="table-responsive">
        <table class="table table-bordered table-hover table-striped">
            ...
            {
                $rs_roles = $obj_userroles->getroleid($row_assignroles['emp_id']);		
            ?>	
                <tr>
                    <td><input name="chkSelect" type="checkbox" id="chkSelect" value="<?php echo $row_assignroles['emp_id'] ?>"></td>
